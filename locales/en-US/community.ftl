...
community-chat = Development of Rust, and general chatter happens on several chat platforms. Check out general channels and more on the Rust Discord server or in the Matrix space, or check out the teams page to find where specific teams meet.
